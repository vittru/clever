                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan><div class="aa-cart-title"><?php
                                ...
                                ?>
                                <tr>
                                    <td colspan="5" class="cart-view-total">Всего товаров на сумму:</td>
                                    <td class="cart-view-total"><?php echo $total . currency ?></td>
                                </tr>                      
                                <tr>
                                        <td colspan="6">
                                        <?php
                                        if ($total) {
                                        ?>
                                              <a href="/buy"><input class="aa-cart-view-btn green button right" type="submit" value="Оформить заказ"></a>
                                        <?php
                                        }
                                        ?>
                                    </td>
