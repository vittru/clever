    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                        <div class="main-desc desc-after">
                                ...
                                <ul>
                                    <li><b>Компоненты натуральной косметики знакомы нашей коже, а значит – организм легче воспринимает экосредства.</b> При использовании природной косметики не наступает эффекта привыкания. Эко косметика не скрывает недостатки под слоем крема, а помогает коже бороться с причинами.</li>
                                    ...
                                    <li><b>При покупке натуральной косметики Вы платите за состав, а не за бренд.</b> При этом производители уделяют особое внимание качеству ингредиентов. При изготовлении используются только цветочные и фруктовые экстракты, масла, витамины - источники питательных веществ для здоровой кожи.   Не смотря на это сама косметика доступна по цене, в сравнении с аналогичными зарубежными товарами.</li>
                                ...
                                <h2>Преимущества приобретения органической косметики в магазине Клевер</h2>
                                <ul>
