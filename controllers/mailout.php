    ...
    function send() {
        if ($this->registry['isadmin']) {
            ...
            foreach ($emails as $id => $to) {
                ...
                $this->sendMail($to, $topic, $message . '<p style="color: rgb(80, 0, 80); font-family: arial, sans-serif; font-size: 12.8px;"><span style="color: rgb(34, 34, 34); font-family: -apple-system, system-ui, Roboto, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 13px;">Ваш&nbsp;<a href="' . siteName . '" target="_blank">Экомаркет Клевер</a>.</span></p><p style="color: rgb(80, 0, 80); font-family: arial, sans-serif; font-size: 12.8px;"><span style="font-family: -apple-system, system-ui, Roboto, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 13px;"><font color="#cec6ce">Вы получили это письмо, потому что подписаны на рассылку Экомаркета Клевер. <a href="' . siteName . '/subscribe/stop?id='.$id.'" target="_blank">Отписаться от рассылки</a>.</font></span></p>');
            }
            header("LOCATION: /");
        } else {
            $this->registry['template']->show('404');
