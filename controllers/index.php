...
Class Controller_Index Extends Controller_Base {
    ...
    function index() {
        ...
        $this->registry['template']->set('metaDescription', 'На официальном сайте магазина Клевер Вы найдете натуральную (органик) косметику для всей семьи. Купить органическую ЭКО косметику в Самаре через интернет-магазин с доставкой.');
