...
Class Controller_Index Extends Controller_Base {
    ...
    function index() {
        ...
        $this->registry['template']->set('reviews', $this->registry['model']->getGoodReviews(0));
        $this->registry['template']->set('metaTitle', 'Купить натуральную косметику в Самаре по низкой цене | Экомаркет Клевер');
